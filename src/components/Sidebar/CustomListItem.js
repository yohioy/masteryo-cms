...
export default function CustomListItem(props) {
    ...
    const parentListItemClasses = classNames({[classes.itemLinkActive]: Boolean(openMenu)});
                ...
                <a className={ classes.listItemSub }>
                    <ListItem button className={classes.nested}>
                        ...
                        <ListItemText primary={
                            <Typography className={ classes.listItemSub }>
                                {subItem.name}
                            </Typography>
                        } />
                    </ListItem>
    ...
    return (
        <>
            <ListItem button onClick={handleMenuClick} className={parentListItemClasses}>
                <ListItemIcon className={ classes.itemIcon }>
                    <item.icon />
                </ListItemIcon>
                ...
                { subMenu.length > 0 ? openMenu ? <ExpandLess className={ caretClasses } /> : <ExpandMore className={ caretClasses } /> : null }
            </ListItem>
