...
export default function CustomTableContainer(props) {
  ...
  const [currentPageList, setCurrentPageList] = React.useState(
    rowData.slice(listStart, listEnd)
  );
      ...
      <Box component={Paper} className={classes.tableMenuContainer}>
        <Grid item xs alignContent="flex-end">
          ...
          <Button
            ...
            size="small"
            startIcon={
              <SettingsBackupRestoreIcon className={classes.btnUnselect} />
            }
            className={classes.tableMenuItem}
          >
            Unselect All
          ...
          <Button
            disabled={btnDisabled}
            size="small"
            startIcon={<CloudUploadIcon className={classes.btnPublished} />}
            className={classes.tableMenuItem}
          >
            Publish
          </Button>
          <Button
            disabled={btnDisabled}
            size="small"
            startIcon={<CloudOffIcon className={classes.btnUnpublished} />}
            className={classes.tableMenuItem}
          >
            Unpublish
          </Button>
          <Button
            disabled={btnDisabled}
            size="small"
            startIcon={<DeleteIcon className={classes.btnDelete} />}
            className={classes.tableMenuItem}
          >
            Delete
          </Button>
                      ...
                      <Link href="/pages/[id]" as={`/pages/${row.id}`}>
                        <a className={classes.listItemSub}>
                          <IconButton aria-label="edit">
                            <EditIcon
                              fontSize="small"
                              className={classes.rowEditButton}
                            />
                          </IconButton>
                        </a>
                      </Link>
